      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-4xl font-bold text-foreground">Strategy Comparison</h1>
          </div>
        ...
        <Card className="mb-8 bg-card/80 backdrop-blur-md border-border">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-foreground">
              <img src={dreamHouse} alt="Dream House" className="w-full h-48 object-cover rounded-lg mb-4" />
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          {options.map((option) => (
            ...
            >
              <CardHeader className={`bg-gradient-to-br ${option.bgGradient} border-b border-border`}>
              ...
              <CardContent className="pt-6 space-y-6">
                ...
                <div className="p-3 bg-primary/10 rounded-lg">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-primary">{option.timeToReady}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Based on your current portfolio and long-term financial goals, we recommend the{" "}
                  <span className="font-semibold text-primary">Strategic Approach</span>. While it involves
                  a small monthly payment, it allows you to maintain exposure to your digital assets,
                  minimizes tax burden, and preserves your wealth-building potential for the future.
                </p>
