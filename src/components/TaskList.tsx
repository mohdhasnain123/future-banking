    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-30">
          <div className="absolute w-full h-px bg-gradient-to-r from-transparent via-primary to-transparent animate-pulse" 
        ...
        >
          ...
          <div 
            className="absolute -inset-1 bg-gradient-to-r from-primary via-purple-500 to-primary opacity-50 blur-sm rounded-lg group-hover:opacity-75 transition-opacity"
            style={{ transform: "translateZ(-2px)" }}
          />
          
          {/* Text with enhanced depth and glow */}
          <h2 
            className="text-4xl font-bold text-white relative bg-gradient-to-r from-white via-primary-foreground to-white bg-clip-text"
            style={{ 
              textShadow: "0 0 20px hsl(var(--primary)/0.8), 0 0 40px hsl(var(--primary)/0.4), 2px 2px 4px rgba(0,0,0,0.5)",
