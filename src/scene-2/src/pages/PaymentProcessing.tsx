...
const PaymentProcessing = () => {
  ...
  // Animate step progression: 15 seconds per step, total 1 minute
  useEffect(() => {
    if (step < 5) {
      const timer = setTimeout(() => setStep(step + 1), 2000); // 10 seconds
  ...
  // Helper for expand/collapse (now stays open after reached)
  const getExpandClass = (currentStep: number) =>
    step >= currentStep
      ? "max-h-[800px] opacity-100 py-2 transition-all duration-500"
      : "max-h-0 opacity-0 py-0 overflow-hidden transition-all duration-500";
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Direct Central Bank to Central Bank Settlement via mBridge
              Protocol
            </p>
          </div>
          ...
          <div className="flex justify-center mb-2">
            {stepLabels.map((label, idx) => (
              <div key={label} className="flex items-center">
                <div
                  className={`rounded-full w-5 h-5 flex items-center justify-center font-bold text-lg transition-all duration-300
                    ${
                      step === idx + 1
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              <div className="text-center bg-card/80 backdrop-blur-sm rounded-xl p-2 border border-primary">
              ...
              {/* Step 1 */}
              <div
                className={`bg-card/80 rounded-xl p-1 border transition-all duration-300 ${getStepClass(
                  1
                )}`}
              >
                <div className="flex items-center gap-2 mb-1">
                  <div
                    className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 ${getBadgeClass(
                      1
                    )}`}
                  >
                    1
              ...
              <div className={getExpandClass(1)}>
              ...
              <div className={getExpandClass(2)}>
                ...
                <div className="bg-card/80 backdrop-blur-sm rounded-xl p-4 border border-primary/50">
                  <h4 className="text-sm font-bold text-foreground mb-2">
                    Digital Rupee Ledger
                  </h4>
                  <p className="text-xs text-success">
                    Transaction: e-₹16,624 → mBridge
                  </p>
                </div>
            ...
            <div className="space-y-2">
              <div className="text-center bg-gradient-to-r from-primary/20 to-primary/10 backdrop-blur-sm rounded-xl p-1 border border-primary">
                ...
                <p className="text-xs text-muted-foreground">
                  Multi-CBDC Interoperability Platform
                </p>
                <p className="text-[10px] text-muted-foreground">
              ...
              <div className={getExpandClass(3)}>
                <div className="bg-gradient-to-br from-primary/10 to-primary/5 backdrop-blur-sm rounded-xl p-1 border border-primary/50">
                ...
                <div className="bg-primary/10 backdrop-blur-sm rounded-xl p-4 border border-primary/30">
                  <h4 className="text-sm font-bold text-center text-foreground mb-2">
                ...
                <div className="bg-success/20 backdrop-blur-sm rounded-xl p-4 border border-success text-center">
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    (vs 2-5 days traditional banking)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              {/* Step 4 */}
              <div
                className={`bg-card/80 rounded-xl p-4 border transition-all duration-300 ${getStepClass(
                  4
                )}`}
              >
              ...
              <div className={getExpandClass(4)}>
                <div className="bg-card/80 backdrop-blur-sm rounded-xl p-4 border border-border">
                  <h4 className="text-sm font-bold text-foreground mb-3">
                    FedNow CBDC System
                  </h4>
                ...
                <div className="bg-card/80 backdrop-blur-sm rounded-xl p-4 border border-success/50">
                  <h4 className="text-sm font-bold text-foreground mb-2">
                    Digital Dollar Ledger
                  </h4>
                  <p className="text-xs text-success">
                    Transaction: mBridge → $200 USD
                  </p>
                </div>
              </div>
              ...
              <div className={getExpandClass(5)}>
                {/* Receiver Wallet (inline, not popup) */}
                <div className="bg-card/80 backdrop-blur-sm rounded-xl p-1 border border-success/50">
          ...
          <div className="grid grid-cols-2 gap-4 mt-8">
            <div className="bg-destructive/20 backdrop-blur-sm rounded-xl p-4 border border-destructive/30">
              <h4 className="text-sm font-bold text-foreground mb-2">
                Traditional Wire: 2-5 days
              </h4>
              <p className="text-xs text-muted-foreground">
                • $25-50 fees • Correspondent banks • Limited hours
              </p>
            </div>
            <div className="bg-success/20 backdrop-blur-sm rounded-xl p-4 border border-success/30">
              <h4 className="text-sm font-bold text-foreground mb-2">
                CBDC Transfer: 3-5 seconds
              </h4>
              <p className="text-xs text-muted-foreground">
                • Near-zero fees • Direct settlement • 24/7
              </p>
            </div>
          </div>
        </div>
